...
-- Insert mock data for accepted experts
...
SELECT 
  ...
  unnest(ARRAY[
    'https://twitter.com/' || CASE 
      ...
      WHEN e.expertise_area = 'exercise' THEN 'exercise_science'
      WHEN e.expertise_area = 'mental_health' THEN 'mindful_research'
      WHEN e.expertise_area = 'sleep' THEN 'sleep_doctor'
      WHEN e.expertise_area = 'supplements' THEN 'supplement_facts'
    END,
    'https://linkedin.com/in/' || CASE 
      WHEN e.expertise_area = 'nutrition' THEN 'dr-sarah-smith'
      WHEN e.expertise_area = 'exercise' THEN 'michael-johnson-phd'
      WHEN e.expertise_area = 'mental_health' THEN 'dr-lisa-chen'
      WHEN e.expertise_area = 'sleep' THEN 'david-williams-md'
      WHEN e.expertise_area = 'supplements' THEN 'dr-alex-rodriguez'
    END,
    'https://researchgate.net/profile/' || CASE 
      WHEN e.expertise_area = 'nutrition' THEN 'Sarah-Smith-2'
      WHEN e.expertise_area = 'exercise' THEN 'Michael-Johnson-15'
      WHEN e.expertise_area = 'mental_health' THEN 'Lisa-Chen-8'
      WHEN e.expertise_area = 'sleep' THEN 'David-Williams-12'
      WHEN e.expertise_area = 'supplements' THEN 'Alex-Rodriguez-5'
    END
  ])
