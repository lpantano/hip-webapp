...
INSERT INTO public.profiles (user_id, display_name, avatar_url, bio) VALUES
  (
    ...
    'AI researcher specializing in machine learning and neural networks.'
  ),
  (
...
-- Insert expert records with enum values that definitely exist
INSERT INTO public.experts (
  ...
  (
    ...
    12,
    'PhD in Computer Science from Stanford University, Postdoc at MIT',
    'I want to help bridge the gap between AI research and public understanding.',
    'https://sarahchen-ai.com',
    'San Francisco, CA',
    'accepted'
  ),
  (
...
SELECT e.id, 'LinkedIn', CASE 
  WHEN e.user_id = '11111111-1111-1111-1111-111111111111' THEN 'https://linkedin.com/in/sarah-chen-ai'
...
SELECT e.id, 'Twitter', CASE
  WHEN e.user_id = '11111111-1111-1111-1111-111111111111' THEN 'https://twitter.com/sarahchen_ai'
