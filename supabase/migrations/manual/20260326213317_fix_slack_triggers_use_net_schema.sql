-- Fix Slack trigger functions: use net.http_post (correct schema) with correct
-- argument types. pg_net's http_post takes body as jsonb, not text.
-- Previous migrations incorrectly used extensions.http_post (doesn't exist)
-- and cast body to ::text.
